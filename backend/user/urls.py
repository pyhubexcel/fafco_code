...
from .views import (
    ...
    PasswordChangeAPI, ProfileAPI, ProfileDetailAPI,AutocompleteAPIView,SingleAddressValidationAPIView
)
...
urlpatterns = [
    ...
    path('profile_detail/<int:pk>/', ProfileDetailAPI.as_view(), name='ProfileDetailAPI'),
    path('autocomplete/', AutocompleteAPIView.as_view(), name='autocomplete'),
    path('validation/', SingleAddressValidationAPIView.as_view(), name='validation'),
]
